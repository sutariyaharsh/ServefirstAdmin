...
class ResponseDetailsScreen extends StatelessWidget {
  const ResponseDetailsScreen({Key? key, required this.index})
      : super(key: key);
                        ...
                        () => Row(
                          ...
                          children: [
                            CircularProgressResponse(
                                valueText:
                                    '${controller.responseData.value!.npsScore!}',
                                value:
                                    controller.responseData.value!.npsScore! /
                                        100,
                                subtitle: "Promotor",
                            ...
                            CircularProgressResponse(
                                valueText:
                                    "${controller.responseData.value!.answerScore!}/${controller.responseData.value!.questionScore!}",
                                value: controller
                            ...
                            CircularProgressResponse(
                                valueText:
                                    '${controller.responseData.value!.resultPercent!}',
                                value: controller
                        ...
                        () => ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return ResponseDetailsListViewItem(
                                answers: controller.answersList[index],
                                index: index);
                          },
                        ),
                      ),
