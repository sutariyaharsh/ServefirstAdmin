...
class RatingTypeQuestion extends StatefulWidget {
  const RatingTypeQuestion(
      {Key? key,
      required this.onRatingItemSelected,
      ...
      : super(key: key);
  final Function(String) onRatingItemSelected;
...
class _RatingTypeQuestionState extends State<RatingTypeQuestion> {
  ...
  void _selectItem(int index) {
    setState(() {
      ...
      getLog("Index : second $_selectedIndex");
  ...
  Widget build(BuildContext context) {
    setState(() {
      ...
      /*getLog("RatingType : ${jsonEncode(widget.surveyController.surveyJsonDataMap[widget.question.sId!]?.value)}");
      if (widget.surveyController.surveyJsonDataMap[widget.question.sId!]?.value != null) {
        _selectedIndex = findIndexById(widget.surveyController.surveyJsonDataMap[widget.question.sId!]?.value as String);
      } else {
        _selectedIndex = -1;
      }*/
    });
