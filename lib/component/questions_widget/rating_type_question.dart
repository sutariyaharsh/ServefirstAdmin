...
class _RatingTypeQuestionState extends State<RatingTypeQuestion> {
  ...
  void _selectItem(int index) {
    setState(() {
      ...
      log("selectedIndex : $_selectedIndex", name: "RatingTypeQuestion");
                ...
                () => Wrap(
                  ...
                  children: List.generate(
                    ...
                    (index) => GestureDetector(
                      onTap: () {
                        _selectItem(index);
                        widget.onRatingItemSelected('${widget.question.options![index].sId}', widget.question.options![index].finishSurvey ?? false,
