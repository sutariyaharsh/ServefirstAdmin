...
class SkillTypeQuestion extends StatefulWidget {
  const SkillTypeQuestion(
      {Key? key,
      required this.onSkillItemsSelected,
      ...
      : super(key: key);
  final Function(List<String>) onSkillItemsSelected;
  ...
  @override
  State<SkillTypeQuestion> createState() => _SkillTypeQuestionState();
}

class _SkillTypeQuestionState extends State<SkillTypeQuestion> {
                    ...
                    (index) => GestureDetector(
                      onTap: () {
                        ...
                        controller.surveyJsonDataMap[widget.question.sId!]
                                    ?.value !=
                                null
                            ? widget.onSkillItemsSelected((controller
                                    .surveyJsonDataMap[widget.question.sId!]
                                    ?.value ??
                                []) as List<String>)
                            : widget.onSkillItemsSelected(_selectedIndices);
                      },
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            SvgIcon(
                                ...
                                width: 20.w,
                                height: 20.h,
                                color: controller.surveyJsonDataMap[widget.question.sId!]?.value !=
                                        null
                                    ? findIndicesByIds(controller
                                                .surveyJsonDataMap[
                                                    widget.question.sId!]
