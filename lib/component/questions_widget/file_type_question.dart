...
class _FileTypeQuestionState extends State<FileTypeQuestion> {
          ...
          children: [
            ...
            Column(
              children: [
                GestureDetector(
                  onTap: () {
                    _showOptionsDialog(context, "FileAnswer", controller);
                  },
                  child: Row(
  ...
  void _showOptionsDialog(BuildContext context, String fileType, SurveyController controller) {
    showDialog(
      context: context,
